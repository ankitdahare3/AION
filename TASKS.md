...
[~] T-003 GitHub Actions CI: build + unit tests + ktlint — AC: green pipeline on push — workflow authored (.github/workflows/ci.yml) + locally verified green (ktlintCheck+test+assembleDebug all pass 2026-07-08); ⚠️ "on push" not yet verified — no GitHub remote configured, push is owner's decision (pending)
