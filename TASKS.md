...
## EPIC 0 — Repo & CI
[ ] T-001 (DOC-020) Complete Gradle setup: root build.gradle.kts, version catalog, wrapper; :android:app + :brain compile — AC: `./gradlew assembleDebug` succeeds
[ ] T-002 Add Hilt, Room, kotlinx.serialization, Compose BOM wiring — AC: clean build, sample @HiltAndroidApp boots in emulator
[ ] T-003 GitHub Actions CI: build + unit tests + ktlint — AC: green pipeline on push
